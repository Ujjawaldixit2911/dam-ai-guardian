...
// Admin only routes
router.get('/users/pending', authMiddleware, adminMiddleware, authController.getPendingUsers);
router.put('/users/:userId/status', authMiddleware, adminMiddleware, authController.updateUserStatus);
