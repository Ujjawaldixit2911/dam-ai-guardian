...
const IoTDashboard: React.FC = () => {
  ...
  // Force offline mode for now
  const sensors = rawSensors.map(s => ({ ...s, status: 'offline' }));
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-md">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="text-lg font-medium text-blue-800">Hardware Integration Roadmap</h3>
            <p className="text-blue-700 text-sm mt-1">
              Currently, all AI/IoT sensors are displayed as <strong>offline</strong>. 
              This interface is ready for our future Phase 2 deployment, where physical hardware modules 
              will be installed on-site and integrated to stream live telemetry directly into this dashboard.
            </p>
          </div>
        </div>
      </div>
