        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold gradient-text leading-none tracking-wide">DAM AI GUARDIAN</h1>
              <p className="text-[10px] text-primary/80 tracking-[0.2em] font-semibold mt-1 uppercase">AI-Powered Safety</p>
            </div>
          </div>
