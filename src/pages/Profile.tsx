      ...
      <div className="glass-card rounded-2xl p-8 border-primary/30">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label htmlFor="name">Full Name <span className="text-xs text-muted-foreground font-normal ml-2">(Contact Admin to change)</span></Label>
            <div className="relative">
              ...
              <Input
                ...
                value={formData.name}
                disabled={true}
                className="pl-10 glass-card opacity-70 cursor-not-allowed"
              />
            </div>
          </div>

          <div className="space-y-2">
            <Label htmlFor="email">Email Address <span className="text-xs text-muted-foreground font-normal ml-2">(Contact Admin to change)</span></Label>
            <div className="relative">
